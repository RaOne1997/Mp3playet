...
import com.abhijeet.mp3player.SongService;
...
public class UpdateReceiver extends AppWidgetProvider {
    public static final String ACTION_PLAY = "com.abhijeet.mp3player.ACTION_PLAY";
    public static final String ACTION_NEXT = "com.abhijeet.mp3player.ACTION_NEXT";
    public static final String ACTION_PREV = "com.abhijeet.mp3player.ACTION_PREV";
    public static final String ACTION_CLOSE = "com.abhijeet.mp3player.ACTION_CLOSE";
